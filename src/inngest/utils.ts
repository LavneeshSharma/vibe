 ...
 *
 * If the content is a string, it is returned directly. If the content is an array, the `text` fields are concatenated and returned as a single string. Returns `undefined` if no assistant message or content is found.
 *
 * @param result - The AgentResult containing message output
